Example application to secure spring boot based based APIs using JWT Tokens. The example has been customized and repackaged and is  based on the the original work by pascal alma
