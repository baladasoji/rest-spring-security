 ...
 */
@Component
public class JWKTokenValidator {
     ...
     */
    public JwtUserDto parseToken(String token, String jwkurl) {
        JwtUserDto u = null;
        ...
        try {
          ...
          System.out.println (" JWK URL is " + jwkurl) ;
          ResourceRetriever rr = new DefaultResourceRetriever (3000,3000);
          JWKSource keySource = new RemoteJWKSet(new URL(jwkurl), rr);
